import{a as p}from"./chunk-2F5WOYMD.js";import{d as u}from"./chunk-JQJUQIVB.js";import{b as m,d as s}from"./chunk-COCUXY5C.js";import{h as l,r as f,s as o}from"./chunk-3AXM2HFE.js";var _=(()=>{class a{constructor(){this.graphql=o(m),this.tvmClient=o(u),this.apiService=o(p),this.cache=new Map,this.pending=new Map}getNameSync(t){if(!t)return null;let n=this.cache.get(t);if(n!==void 0)return n;let i=s(t);return i?(this.cache.set(t,i),i):null}async resolveName(t){if(!t)return null;if(this.cache.has(t))return this.cache.get(t);let n=s(t);if(n)return this.cache.set(t,n),n;let i=this.pending.get(t);if(i)return i;let e=this.fetchName(t);this.pending.set(t,e);try{let c=await e;return this.cache.set(t,c),c}finally{this.pending.delete(t)}}async resolveNames(t){let n=[...new Set(t.filter(e=>e&&e.length>0))];await Promise.allSettled(n.map(e=>this.resolveName(e)));let i=new Map;for(let e of n){let c=this.cache.get(e);c&&i.set(e,c)}return i}async fetchName(t){try{let e=(await l(this.graphql.query(`
