import{d as y}from"./chunk-CX6SF73B.js";import{a as p}from"./chunk-6GV4RLCP.js";import{c as g}from"./chunk-5RKEQHWJ.js";import{b as u,m as h}from"./chunk-CP6DEO5Z.js";import{L as f,P as o,l}from"./chunk-TPQ77ZJP.js";var C=(()=>{class c{constructor(){this.graphql=o(u),this.tvmClient=o(g),this.apiService=o(p),this.cache=new Map,this.pending=new Map}getDisplayName(t,e){return t?e?.get(t)??this.getNameSync(t):null}formatAddressOrName(t,e){return this.getDisplayName(t,e)||y(t)}getNameSync(t){if(!t)return null;let e=this.cache.get(t);if(e!==void 0)return e;let n=h(t);return n?(this.cache.set(t,n),n):null}async resolveName(t){if(!t)return null;if(this.cache.has(t))return this.cache.get(t);let e=h(t);if(e)return this.cache.set(t,e),e;let n=this.pending.get(t);if(n)return n;let i=this.fetchName(t);this.pending.set(t,i);try{let r=await i;return this.cache.set(t,r),r}catch(r){return null}finally{this.pending.delete(t)}}async resolveNames(t){let e=[...new Set(t.filter(i=>i&&i.length>0))];await Promise.allSettled(e.map(i=>this.resolveName(i)));let n=new Map;for(let i of e){let r=this.cache.get(i);r&&n.set(i,r)}return n}async fetchName(t){let i=(await l(this.graphql.query(`
